...
const ProgressSection = () => {
  ...
  return (
    <section id="progress" className="relative overflow-hidden py-24 bg-background">
      {/* animated ombre glow background (pink motif) */}
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-24 -left-24 h-[420px] w-[420px] rounded-full bg-fuchsia-400/35 blur-3xl animate-[pulse_9s_ease-in-out_infinite]" />
        <div className="absolute top-10 right-[-140px] h-[520px] w-[520px] rounded-full bg-pink-400/30 blur-3xl animate-[pulse_11s_ease-in-out_infinite]" />
        <div className="absolute -bottom-32 left-1/3 h-[560px] w-[560px] rounded-full bg-purple-400/25 blur-3xl animate-[pulse_13s_ease-in-out_infinite]" />
        <div className="absolute inset-0 bg-gradient-to-b from-background/30 via-background/70 to-background" />
      </div>

      <div className="relative container mx-auto px-4">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-fuchsia-500/15 mb-4 shadow-[0_0_0_6px_rgba(217,70,239,0.12)]">
            <Target className="w-7 h-7 text-fuchsia-700" />
          </div>

          <span className="block text-fuchsia-700 font-medium mb-4">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-card/70 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-border shadow-xl">
            {/* main numbers */}
            <div className="text-center mb-8">
              ...
              <div className="mt-4">
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-fuchsia-500/15 text-fuchsia-800 text-sm font-medium shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 rounded-2xl bg-background/60 border border-border/60">
                <Target className="w-8 h-8 mx-auto mb-2 text-fuchsia-700" />
                <p className="text-2xl font-bold">₱{GOAL_AMOUNT.toLocaleString()}</p>
                <p className="text-sm text-muted-foreground">Goal</p>
              </div>

              <div className="text-center p-4 rounded-2xl bg-background/60 border border-border/60">
                <Wallet className="w-8 h-8 mx-auto mb-2 text-pink-700" />
